 const City = ["New york ", "London", "Tashkent", "Baku " ,"Istanbul", "Almaty",""];
 const Position = [ "Vue Js", "C++","React", "Nodejs", "Go", "Python"];
 const TypePosition = ["junior", "junior +", "middle", "senior"];
 ...
 function deletePupil(id) {
   let isConfirm = confirm("really do you want to delete this ?");
   if (isConfirm) {
 ...
 filterPosition.addEventListener("change", function () {
   if (this.value == "Change the level of work") {
     getPupils();
   } else {
